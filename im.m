% Start of Image Analysis program translation from imageJ
% Script makes movie and calls script for selection
%
% March 2008
% Lana Bosanac
...
screensize = get(0,'ScreenSize');
 ...
 set(gcf,'Position',[lef bot wid hei],'BackingStore','off','MenuBar','figure',...
     'NumberTitle','off','Name','FLIP Image Analysis','Color',[0.49 1 0.83]);
...
hconload  = uicontrol('Style','Pushbutton', ...
    'Position',[left1+0.25*wid1 bot_title 0.75*(wid1+wid2) 2*height], ...
    'String','Load Images',...
    'BackgroundColor','w',...
    'Callback','loadi');
